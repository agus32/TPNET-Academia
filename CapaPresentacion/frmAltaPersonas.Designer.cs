namespace CapaPresentacion
{
    partial class frmAltaPersonas
    {
        ...
        {
            lblNombre_frmAltaPersona = new Label();
            lblApellido_frmAltaPersona = new Label();
            lblDireccion_frmAltaPersona = new Label();
            lblMail_frmAltaPersona = new Label();
            lblFechaNac_frmAltaPersona = new Label();
            lblLegajo_frmAltaPersona = new Label();
            lblTelfono_frmAltaPersona = new Label();
            lblTipoPersona_frmAltaPersona = new Label();
            lblIdPlan_frmAltaPersona = new Label();
            txtNombre_frmAltaPersona = new TextBox();
            txtApellido_frmAltaPersona = new TextBox();
            txtDireccion_frmAltaPersona = new TextBox();
            txtMail_frmAltaPersona = new TextBox();
            txtLegajo_frmAltaPersona = new TextBox();
            txtTelefono_frmAltaPersona = new TextBox();
            dtpFechaNac_frmAltaPersona = new DateTimePicker();
            cbTipoPersona_frmAltaPersona = new ComboBox();
            cbPlan_frmAltaPersona = new ComboBox();
            dgvPersonas_AltaPersonas = new DataGridView();
            btnGuardar_frmAltaPersonas = new Button();
            btnModificar_frmAltaPersona = new Button();
            btnBorrar_frmAltaPersona = new Button();
            ((System.ComponentModel.ISupportInitialize)dgvPersonas_AltaPersonas).BeginInit();
            SuspendLayout();
            // 
            ...
            btnGuardar_frmAltaPersonas.Click += button1_Click;
            // 
            // btnModificar_frmAltaPersona
            // 
            btnModificar_frmAltaPersona.Location = new Point(187, 590);
            ...
            btnModificar_frmAltaPersona.Click += btnModificar_frmAltaPersona_Click;
            // 
            // btnBorrar_frmAltaPersona
            // 
            btnBorrar_frmAltaPersona.BackColor = Color.Red;
            btnBorrar_frmAltaPersona.ForeColor = SystemColors.ButtonHighlight;
            btnBorrar_frmAltaPersona.Location = new Point(350, 590);
            ...
            btnBorrar_frmAltaPersona.Click += btnBorrar_frmAltaPersona_Click;
            // 
            // frmAltaPersonas
            // 
            ...
            Controls.Add(btnGuardar_frmAltaPersonas);
            Controls.Add(dgvPersonas_AltaPersonas);
            Controls.Add(cbPlan_frmAltaPersona);
            Controls.Add(cbTipoPersona_frmAltaPersona);
            Controls.Add(dtpFechaNac_frmAltaPersona);
            Controls.Add(txtTelefono_frmAltaPersona);
            Controls.Add(txtLegajo_frmAltaPersona);
            Controls.Add(txtMail_frmAltaPersona);
            Controls.Add(txtDireccion_frmAltaPersona);
            Controls.Add(txtApellido_frmAltaPersona);
            Controls.Add(txtNombre_frmAltaPersona);
            Controls.Add(lblIdPlan_frmAltaPersona);
            Controls.Add(lblTipoPersona_frmAltaPersona);
            Controls.Add(lblTelfono_frmAltaPersona);
            Controls.Add(lblLegajo_frmAltaPersona);
            Controls.Add(lblFechaNac_frmAltaPersona);
            Controls.Add(lblMail_frmAltaPersona);
            Controls.Add(lblDireccion_frmAltaPersona);
            Controls.Add(lblApellido_frmAltaPersona);
            Controls.Add(lblNombre_frmAltaPersona);
            Name = "frmAltaPersonas";
            Text = "Form2";
            Load += frmAltaPersonas_Load_1;
            ((System.ComponentModel.ISupportInitialize)dgvPersonas_AltaPersonas).EndInit();
            ResumeLayout(false);
            PerformLayout();
        }
        ...
        private Label lblNombre_frmAltaPersona;
        private Label lblApellido_frmAltaPersona;
        private Label lblDireccion_frmAltaPersona;
        private Label lblMail_frmAltaPersona;
        private Label lblFechaNac_frmAltaPersona;
        private Label lblLegajo_frmAltaPersona;
        private Label lblTelfono_frmAltaPersona;
        private Label lblTipoPersona_frmAltaPersona;
        private Label lblIdPlan_frmAltaPersona;
        private TextBox txtNombre_frmAltaPersona;
        private TextBox txtApellido_frmAltaPersona;
        private TextBox txtDireccion_frmAltaPersona;
        private TextBox txtMail_frmAltaPersona;
        private TextBox txtLegajo_frmAltaPersona;
        private TextBox txtTelefono_frmAltaPersona;
        private DateTimePicker dtpFechaNac_frmAltaPersona;
        private ComboBox cbTipoPersona_frmAltaPersona;
        private ComboBox cbPlan_frmAltaPersona;
        private DataGridView dgvPersonas_AltaPersonas;
        private Button btnGuardar_frmAltaPersonas;
        private Button btnModificar_frmAltaPersona;
        private Button btnBorrar_frmAltaPersona;
    }
}